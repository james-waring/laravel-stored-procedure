...
it('can get multiple result sets, paginate', function () {
    $result = TestModel::CallStoredProcedure('test_procedure', ['hello world'], 2)->paginate();
...
it('can get multiple result sets, paginate, 10 results per page', function () {
    ...
    $result = TestModel::CallStoredProcedure('test_procedure', ['hello world'], 2)->paginate(10);
...
it('can hydrate models', function () {
    ...
    $result = TestModel::CallStoredProcedure('test_procedure', ['hello world'], 2)
